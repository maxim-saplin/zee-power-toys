...
Настройки на DHU (планшет / головное устройство). Язык: **EN** или **RU** в разделе «Язык».

### 1. Главная

Слева — статус компаньонов; справа в **Разделах** — **HUD**, **Миникарта**, **Камеры** и остальное.

![Главная (EN)](docs/assets/en-home.png)

![Главная (RU)](docs/assets/ru-home.png)

### 2. Камеры (Speedcam)

Пакеты OSM, алерты на приближении, вид радара Alien/Default, опционально обогащение/сбор YNavi. YNavi для Speedcam не обязателен.

![Камеры (EN)](docs/assets/en-speedcam.png)

![Камеры (RU)](docs/assets/ru-speedcam.png)

### 3. Язык и оформление

Переключение UI приложения EN/RU (и тема). Язык системы/кластера — для автомобиля, когда доступно.

![Язык (EN)](docs/assets/en-language.png)
