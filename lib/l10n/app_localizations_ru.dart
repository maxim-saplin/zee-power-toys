...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get showDriveModeCornerDotHint =>
      'Маленькая цветная точка в правом нижнем углу HUD для текущего режима (ECO — синяя, Comfort — зелёная, Sport — красная). Горит постоянно, пока включена; всплывающее уведомление при смене режима по-прежнему работает.';
  ...
  @override
  String get simulateDriveModeLabel => 'Режим движения';
