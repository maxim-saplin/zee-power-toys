...
## Definition of Done
- [ ] `ext.zee.speedcam` drive / path command (or scripted FL sequence) moves host over time
- [ ] ≥2 cams: enter → CRT+sting once; between cams silent when outside 500 m; second cam re-arms
